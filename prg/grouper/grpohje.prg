...
@ 15,5 say '[F12] - Start grouping'
@ 16,5 say '[F11] - Calculate means of expences and durations'
@ 17,5 say '[F10] - Add calculated weights to original data'
@ 18,6 say '[Ctrl][F10] - read weights from other dataset'
...
on key label ctrl+F10 do readwe
