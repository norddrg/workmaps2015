...
do while lc_n<apu_n
  ...
  or substr(apuarr(lc_n,1),3,1)='O' or substr(apuarr(lc_n,1),3,1)='D';
  or substr(apuarr(lc_n,1),3,1)='T' or substr(apuarr(lc_n,1),3,1)='V'
  ...
  if substr(apuarr(lc_n,1),3,1)='C' or substr(apuarr(lc_n,1),3,1)='I' or substr(apuarr(lc_n,1),3,1)='G'
...
if anal_kompl<'2'
 lc_cc='0'
 do while lc_n<apu_n
  if substr(apuarr(lc_n,1),3,1)='I' or substr(apuarr(lc_n,1),3,1)='C' OR substr(apuarr(lc_n,1),3,1)='G'
